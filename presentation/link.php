...
class Link {
    ...
    public static function ToMenu($categoryId, $page = 1) {
        $link = self::CleanUrlText(Catalog::GetCategoryName($categoryId)) .
                '-c' . $categoryId . '/';
    ...
    public static function ToSubMenu($categoryId, $page = 1) {
        $link = self::CleanUrlText(Catalog::GetCategoryName($categoryId)) .
                '-c' . $categoryId . '/';
    ...
    public static function ToSubCategory($productId, $page = 1) {
