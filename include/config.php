...
define('SITE_GENERIC_ERROR_MESSAGE', '<h1>CasadosMigueis Error!</h1>');

// Database connectivity setup
define('DB_PERSISTENCY', 'true');
define('DB_SERVER', 'localhost');
define('DB_USERNAME', 'casamigueisadmin');
define('DB_PASSWORD', 'casamigueisadmin');
define('DB_DATABASE', 'casadosmigueis');
...
define('VIRTUAL_LOCATION', '/casadosmigueis/');
